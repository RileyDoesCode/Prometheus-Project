...
local function writeU24(u24)
	...
	return {
		bit32.band(u24, 255),
		bit32.band(bit32.rshift(u24, 8), 255),
		bit32.band(bit32.rshift(u24, 16), 255)
	}
end
...
local function writeU32(u32)
	...
	return {
		bit32.band(u32, 255),
		bit32.band(bit32.rshift(u32, 8), 255),
		bit32.band(bit32.rshift(u32, 16), 255),
		bit32.band(bit32.rshift(u32, 24), 255)
	}
end
...
local function bytesToString(arr)
	...
	for i = 1, math.floor(length / MAX_UNPACK_COUNT) do
...
local function isU32(n)
	return type(n) == "number" and n >= 0 and n <= 4294967295 and math.floor(n) == n
end
